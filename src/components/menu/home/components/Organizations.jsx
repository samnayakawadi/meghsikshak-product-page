...
const Organizations = () => {
    return (
        <div className="px-4 md:px-10 bg-gradient-to-r from-blue-50 via-indigo-50 to-purple-50 darkR:from-indigo-800 darkR:via-purple-800 darkR:to-pink-800 py-10">
            <div className="px-4 md:px-44 pb-10">
                ...
                <div className="pt-2 text-center text-base md:text-lg text-gray-700 darkR:text-gray-300">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-10 items-center">
                ...
                <div className="card bg-gradient-to-r from-indigo-100 to-purple-100  transition-transform duration-300 ease-in-out h-full rounded-xl overflow-hidden">
                    <div className="card-body bg-white darkR:bg-gray-800 rounded-b-xl p-4 md:p-6">
                        <div className="flex justify-center text-indigo-500 text-4xl md:text-6xl">
                            <i className="fa-solid fa-landmark" />
                        </div>
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 darkR:text-white text-center mt-4">Government</h2>
                        <p className="pt-2 md:pt-4 text-gray-600 darkR:text-gray-300 text-sm md:text-base">
                        ...
                        <ul className="flex flex-col gap-2 pt-2 md:pt-4">
                            <li className="flex flex-row gap-2 md:gap-4 justify-start items-center text-gray-600 darkR:text-gray-300 text-sm md:text-base">
                ...
                <div className="card bg-gradient-to-r from-indigo-100 to-purple-100  transition-transform duration-300 ease-in-out h-full rounded-xl overflow-hidden">
                    <div className="card-body bg-white darkR:bg-gray-800 rounded-b-xl p-4 md:p-6">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 darkR:text-white text-center mt-4">Corporates</h2>
                        <p className="pt-2 md:pt-4 text-gray-600 darkR:text-gray-300 text-sm md:text-base">
                ...
                <div className="card bg-gradient-to-r from-indigo-100 to-purple-100  transition-transform duration-300 ease-in-out h-full rounded-xl overflow-hidden">
                    <div className="card-body bg-white darkR:bg-gray-800 rounded-b-xl p-4 md:p-6">
                        ...
                        <h2 className="text-2xl md:text-3xl font-bold text-gray-800 darkR:text-white text-center mt-4">Education</h2>
                        <p className="pt-2 md:pt-4 text-gray-600 darkR:text-gray-300 text-sm md:text-base">
